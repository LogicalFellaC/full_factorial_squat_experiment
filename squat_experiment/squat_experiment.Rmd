...
* Adapted from the report submitted to Stanford University's STATS 363: Design
of Experiments.
...
Repetition was necessary to get an error estimate for the effects, since
interactions between the effects were expected to be significant. 
